...
class AdminOrderController extends Controller
{
    ...
    public function updateStatus(Request $request, int $id)
    {
        ...
        // Email the customer about the status change — but only if it
        // ACTUALLY changed (admin might re-save with the same value),
        // and only if the order is still associated with a user (older
        // orders may have user_id=NULL after a deletion).
